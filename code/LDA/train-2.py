...
def plot_coherence_scores(coherence_scores, output_dir):
    """
    Plots coherence scores for different numbers of topics.
    
    Args:
        coherence_scores (dict): Dictionary where keys are number of topics and values are coherence scores.
...
def main_training():
    ...
    for num_topics in range(2, 9):
        ...
        # Visualize LDA model for each number of topics
        print(f"Visualizing LDA model with {num_topics} topics...")
        visualize_lda_model(lda_model, dictionary, doc_term_matrix, output_dir, num_topics)
    
    # Plot coherence scores
    print("Plotting coherence scores...")
    plot_coherence_scores(coherence_scores, output_dir)
    
    # Generate document-topic matrix for the best model
    ...
    lda_model, dictionary, doc_term_matrix = train_lda_model(processed_corpus, best_num_topics, passes)
    
    # Visualize LDA model for the best number of topics
    print("Visualizing final LDA model...")
    visualize_lda_model(lda_model, dictionary, doc_term_matrix, output_dir, best_num_topics)
